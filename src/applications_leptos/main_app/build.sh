...
# Output to public/wasm/leptos/main_app/ so Astro can serve the files
wasm-pack build --target web --out-dir ../../../public/wasm/leptos/main_app --release

# Remove auto-generated .gitignore (we want to commit these files)
rm -f ../../../public/wasm/leptos/main_app/.gitignore

echo "✅ WASM build complete! Output in public/wasm/leptos/main_app/"
