...
use pages::{Dashboard, Accounts, AccountDetail};
use store::WaapiStore;
                ...
                <div class="flex h-screen overflow-hidden">
                    ...
                    <div class="flex flex-col flex-1 overflow-hidden">
                        ...
                        <main class="flex-1 overflow-y-auto">
                            <Routes>
                                <Route path="/waapi" view=Dashboard/>
                                <Route path="/waapi/dashboard" view=Dashboard/>
                                <Route path="/waapi/accounts" view=Accounts/>
                                <Route path="/waapi/accounts/:jid" view=AccountDetail/>
                            </Routes>
                        </main>
                    </div>
                </div>
...
#[wasm_bindgen]
pub fn mount_waapi_app() -> Result<(), JsValue> {
